...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Durée d’attente d’une réponse à une question de clarification avant de sélectionner automatiquement la première option (ou d’expirer s’il n’y a pas d’options). 0 = attendre indéfiniment. Par défaut 60s. Ne s’applique pas aux permissions ni aux confirmations d’envoi de formulaire.',
