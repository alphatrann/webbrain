...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Cuánto esperar una respuesta a una pregunta de aclaración antes de elegir automáticamente la primera opción (o agotar el tiempo si no hay opciones). 0 = esperar indefinidamente. Predeterminado 60s. No se aplica a permisos ni confirmaciones de envío de formularios.',
