...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Berapa lama menunggu balasan pada prompt klarifikasi sebelum memilih opsi pertama secara otomatis (atau timeout jika tidak ada opsi). 0 = menunggu tanpa batas. Default 60 detik. Tidak berlaku untuk izin atau konfirmasi kirim formulir.',
