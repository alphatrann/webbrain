...
export default {
  ...
  'st.memory.desc_html': 'Save stable preferences WebBrain should remember, such as answer style, recurring workflow choices, or durable profile hints. Explicit <code>/remember</code> saves immediately; automatic learning is optional and runs only after a turn completes.',
