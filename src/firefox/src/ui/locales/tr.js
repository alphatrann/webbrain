...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Açıklama sorusuna yanıt için ne kadar bekleneceği; süre dolunca ilk seçenek otomatik seçilir (seçenek yoksa zaman aşımı). 0 = süresiz bekle. Varsayılan 60 sn. İzin ve form gönderim onaylarına uygulanmaz.',
