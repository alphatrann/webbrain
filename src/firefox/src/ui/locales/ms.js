...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Berapa lama menunggu balasan soalan penjelasan sebelum memilih pilihan pertama secara automatik (atau tamat masa jika tiada pilihan). 0 = tunggu tanpa had. Lalai 60s. Tidak digunakan untuk kebenaran atau pengesahan hantar borang.',
