...
export default {
  ...
  'st.display.clarify_timeout.desc': 'Gaano katagal maghintay ng sagot sa clarify bago awtomatikong piliin ang unang opsyon (o mag-timeout kung walang opsyon). 0 = walang hangganan. Default 60s. Hindi para sa permission o form-submit confirmations.',
